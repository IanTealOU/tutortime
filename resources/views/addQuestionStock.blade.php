...
<div class="maincontent">
    ...
    <form method="post" action="index.blade.php?page=confirmQuestion" enctype="multipart/form-data">
        <p>Question Name: <input type="text" name="name" value="<?php echo $_SESSION['addQuestionStock']['name']; ?>"/>
        </p>
        ...
        <p>question: <textarea name="question" cols=60
                               rows=5><?php echo $_SESSION['addQuestionStock']['question']; ?></textarea></p>
